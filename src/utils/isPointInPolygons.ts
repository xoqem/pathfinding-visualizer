...
function isPointInPolygon(point: PointData, polygon: Polygon | null, strokeWidth: number) {
...
export default function isPointInPolygons(
  ...
  return polygons.some((polygon) => isPointInPolygon(point, polygon, strokeWidth));
}
